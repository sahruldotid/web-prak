...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Edit Account</h2>
            ...
            <div class="form-group">
                ...
                <input type="text" name="education" class="form-control" maxlength="20" value="{{$user->profile->education}}">
            </div>
            <div class="form-group">
                <label>Skill</label>
                <input type="text" name="skill" class="form-control" maxlength="20"  value="{{$user->profile->skill}}">
            </div>
            <div class="form-group">
